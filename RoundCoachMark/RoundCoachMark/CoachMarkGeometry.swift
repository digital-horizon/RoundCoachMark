...
//  CoachMark
//
//  Created by Dm. Demenchoock on 14/12/2017.
...
public class CoachMarkGeometry : NSObject {
    ...
    @objc dynamic public class func drawCoachRing(controlRadius: CGFloat = 20, controlCenter: CGPoint = CGPoint(x: 199, y: 137), ringRadius: CGFloat = 144, ringCenter: CGPoint = CGPoint(x: 179, y: 171)) {
        //// Color Declarations
        let ringColor = UIColor(red: 0.000, green: 0.387, blue: 0.742, alpha: 0.737)
